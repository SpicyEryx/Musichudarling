...
# CONFIG
# -----------------------
BOT_TOKEN = os.getenv('BOT_TOKEN', '8303724953:AAFDIuzkHIZ1tjr2fbrIyNOH9CXDR5hyKR4')
ADMIN_ID = int(os.getenv('ADMIN_ID', '8549583525'))
...
def show_main_menu(chat_id):
    ...
    if is_user_banned(user_id):
        bot.send_message(
            ...
            "Contact admin @SpicyEryx for assistance."
        )
        return
...
📱 UPI ID: <code>heyyyynitin-1@okicici</code>
</blockquote>
